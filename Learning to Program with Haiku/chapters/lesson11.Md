...
// The type of dataThe new name for the data

typedef signed char\_\_haiku\_std\_int8;

typedef unsigned char\_\_haiku\_std\_uint8;

typedef signed short\_\_haiku\_std\_int16;

typedef unsigned short\_\_haiku\_std\_uint16;

typedef signed int\_\_haiku\_std\_int32;

typedef unsigned int\_\_haiku\_std\_uint32;

typedef signed long long\_\_haiku\_std\_int64;

typedef unsigned long long\_\_haiku\_std\_uint64;
...
typedef\_\_haiku\_int8int8; // an 8-bit signed integer

typedef\_\_haiku\_uint8uint8; // an 8-bit unsigned integer

typedef\_\_haiku\_int16int16; // a 16-bit signed integer

typedef \_\_haiku\_uint16uint16; // a 16-bit unsigned integer

typedef\_\_haiku\_int32int32; // a 32-bit signed integer

typedef \_\_haiku\_uint32uint32; // a 32-bit unsigned integer

typedef\_\_haiku\_int64int64; // a 64-bit signed integer

typedef \_\_haiku\_uint64uint64; // a 64-bit unsigned integer
...
enum card\_suit cardSuit = SUIT\_HEARTS;
...
// Keep in mind that SUIT\_HEARTS has a value of 0 when used as an integer and

// SUIT\_SPADES has a value of 3. We'll capitalize on their integer values later on
...
SUIT\_NONE// This is for the jokers, and I don't mean me.
...
// use the integer value of the items in the card\_suit type as an index in this
...
// the card\_value values as integers to look up the string holding the friendly
...
for (uint8 suitValue = SUIT\_HEARTS; suitValue \< SUIT\_NONE; suitValue++)
...
for (uint8 cardValue = CARD\_2; cardValue \< CARD\_JOKER; cardValue++)

{

deck\[deckIndex\].value = (card\_value)cardValue;

deck\[deckIndex\].suit = (card\_suit)suitValue;
...
deck\[deckIndex\].value = CARD\_JOKER;

deck\[deckIndex\].suit = SUIT\_NONE;
...
// defined constant RAND\_MAX, which is at least 32767. To make
...
// for the definitions for card\_value and card\_suit near the top of
