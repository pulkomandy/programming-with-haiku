...
Virtual Functions {#_virtual_functions}
-----------------
...
Static Functions {#_static_functions}
----------------
...
Overloading: Functions with the Same Name {#_overloading_functions_with_the_same_name}
-----------------------------------------
