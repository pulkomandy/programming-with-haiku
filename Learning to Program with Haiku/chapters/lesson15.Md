...
***Overview of the Haiku API*** {#_overview_of_the_haiku_api}
-------------------------------
...
### Application Kit {#_application_kit}
...
### Translation Kit {#_translation_kit}
...
Event-Based Programming {#_event_based_programming}
-----------------------
...
***Haiku Messaging*** {#_haiku_messaging}
---------------------
...
### MainWindow.cpp {#_mainwindow_cpp}
